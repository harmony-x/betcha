...
export default function HomeIcon(props: SVGProps<SVGSVGElement>): JSX.Element {
  return (
    <svg
      ...
      {...props}
    >
      <g filter="url(#filter0_i_150_366)">
        <path
        ...
        />
        <path
          d="M8.03212 32.9679C8.03212 46.7573 19.2106 57.9358 33 57.9358C46.7894 57.9358 57.9679 46.7573 57.9679 32.9679C57.9679 19.1785 46.7894 8 33 8C19.2106 8 8.03212 19.1785 8.03212 32.9679Z"
          fill="url(#paint0_linear_150_366)"
        />
        <path
      ...
      >
        <path
          d="M23.25 28.5V42.5H40.75V28.5L32 21.5L23.25 28.5Z"
          fill="white"
          stroke="white"
          strokeWidth="4"
          strokeLinecap="round"
        ...
        />
        <path
          d="M29.0835 34.9165V42.4998H34.9168V34.9165H29.0835Z"
          fill="black"
          stroke="black"
          strokeWidth="4"
          strokeLinejoin="round"
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            mode="normal"
            in2="shape"
            result="effect1_innerShadow_150_366"
          />
        </filter>
        <linearGradient
          id="paint0_linear_150_366"
          x1="64"
          y1="2.28568"
          x2="4.68797"
          y2="64"
